        ...
        <div className="cadastro-box">
          <form onSubmit={handleSubmit} className="cadastro-form">
            ...
            <div className="cadastro-input-wrap" style={{display: 'flex', alignItems: 'center', gap: 8}}>
              ...
              <button type="button" className="cadastro-btn btn-lupa" onClick={handleBuscarMembro} title="Buscar CPF" style={{ width: 28, height: 32, minWidth: 0, padding: 0, display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
